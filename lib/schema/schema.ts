...
import {
	PATH_TRANSACTION_TYPE,
	PATH_PARTY_TYPE,
	PATH_TRANSPORT_BY,
	PATH_COUNTRY,
	PATH_CATEGORY,
	PATH_OBJECT_PROPERTY,
	PATH_PARTY_PROPERTY
...
export function fetchCategories(client: Client): SafePromise<ObjectCategory[], Error> {
	return requestJson(client, PATH_CATEGORY, isObjectCategoryArray);
}
...
export function fetchObjectProperties(client: Client): SafePromise<PropertySpec[], Error> {
	return requestJson(client, PATH_OBJECT_PROPERTY, isPropertySpecArray);
}
...
export function fetchPartyProperties(client: Client): SafePromise<PropertySpec[], Error> {
	return requestJson(client, PATH_PARTY_PROPERTY, isPropertySpecArray);
}
